...
static const ProcCoeff gProcCoeffs[] = {
    ...
    { multiply_modeproc,	SkXfermode::kOne_Coeff,    SkXfermode::kISA_Coeff },
	{ screen_modeproc,      SkXfermode::kOne_Coeff,       SkXfermode::kISA_Coeff  },
    { overlay_modeproc,     SkXfermode::kOne_Coeff,       SkXfermode::kISA_Coeff  },
    { darken_modeproc,      SkXfermode::kOne_Coeff,       SkXfermode::kISA_Coeff  },
    { lighten_modeproc,     SkXfermode::kOne_Coeff,       SkXfermode::kISA_Coeff  },
    { colordodge_modeproc,  SkXfermode::kOne_Coeff,       SkXfermode::kISA_Coeff  },
    { colorburn_modeproc,   SkXfermode::kOne_Coeff,       SkXfermode::kISA_Coeff  },
    { hardlight_modeproc,   SkXfermode::kOne_Coeff,       SkXfermode::kISA_Coeff  },
    { softlight_modeproc,   SkXfermode::kOne_Coeff,       SkXfermode::kISA_Coeff  },
    { difference_modeproc,  SkXfermode::kOne_Coeff,       SkXfermode::kISA_Coeff  },
    { exclusion_modeproc,   SkXfermode::kOne_Coeff,       SkXfermode::kISA_Coeff  },
};
